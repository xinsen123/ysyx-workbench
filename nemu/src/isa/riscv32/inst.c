...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
	...
	INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulhsu , R, R(rd) = (sword_t)(((int64_t)(sword_t)src1 * src2) >> 32));
	...
	INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem 	 , R, R(rd) = src2 == 0 ? (word_t)-1 : (sword_t)src1 % (sword_t)src2);
	INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu 	 , R, R(rd) = src2 == 0 ? (word_t)-1 : src1 % src2);
